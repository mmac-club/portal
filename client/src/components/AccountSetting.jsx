        ...
        <FormControl id="Address">
          <HStack>
            <VStack align={"left"}>
              ...
              <Input
                type="date"
                placeholder={new Date(userData.dateOfBirth).toLocaleDateString(
                  "en-US",
                  {
                    year: "numeric",
                    month: "2-digit",
                ...
                name="dateOfBirth"
                value={
                  isEditing ? editableData.dateOfBirth : userData.dateOfBirth
                }
                onChange={(e) =>
          ...
          <HStack>
            <VStack align={"left"}>
              ...
              <Input
                ...
                type="text"
                value={
                  isEditing ? editableData.phoneNumber : userData.phoneNumber
                }
                onChange={(e) =>
            ...
            <VStack align={"left"}>
              ...
              <Input
                ...
                type="text"
                value={
                  isEditing ? editableData.postalCode : userData.postalCode
                }
                isDisabled={!isEditing}
                onChange={(e) =>
